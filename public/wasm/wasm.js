...
export class GameState {
     ...
     */
    static new(size) {
        const ret = wasm.gamestate_new(size);
     ...
     */
    get_coin_count() {
        const ret = wasm.gamestate_get_coin_count(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    load_level(level_num) {
        ...
        let deferred1_1;
        try {
            const ret = wasm.gamestate_load_level(this.__wbg_ptr, level_num);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get_board() {
        const ret = wasm.gamestate_get_board(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
     */
    get_player_pos() {
        const ret = wasm.gamestate_get_player_pos(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    move_forward() {
        wasm.gamestate_move_forward(this.__wbg_ptr);
    }
    /**
    ...
    turn(direction) {
        ...
        wasm.gamestate_turn(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} direction
     * @returns {any}
    ...
    get_neighbour(direction) {
        const ptr0 = passStringToWasm0(direction, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.gamestate_get_neighbour(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {Array<any>}
    ...
    get_neighbouring_cells() {
        const ret = wasm.gamestate_get_neighbouring_cells(this.__wbg_ptr);
        return ret;
    }
}
